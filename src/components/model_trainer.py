...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            best_model_score=max(sorted([test_score for train_score,test_score in model_report.values()]))

            best_model_name=list(model_report.keys())[
                [test_score for train_score,test_score in model_report.values()].index(best_model_score)
            ]
